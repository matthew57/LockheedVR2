...
namespace UnityEngine.Networking
{
    ...
    [AddComponentMenu("Network/DefNetTrans")]
    public class DefNetTrans : NetworkBehaviour
    {
        ...
        static public void HandleTransform(NetworkMessage netMsg)
        {
            ...
            DefNetTrans foundSync = foundObj.GetComponent<DefNetTrans>();

            Debug.Log("ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ" + netId);
            if (foundSync == null)
            {
